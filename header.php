	...
	<div class="container">
		<div class="row inner">
			<div class="col-md-4 logo">
				<a href="index.php"><img src="assets/uploads/<?php echo $logo; ?>" alt="logo image"><span>Izzy</span></a>
			</div>
			...
			<div class="col-md-5 right">
				<ul>
					...
					if(isset($_SESSION['customer'])) {
						?>
						<li style="color: white;"><i class='fas fa-user-check'></i><span> <?php echo LANG_VALUE_13; ?> <?php echo $_SESSION['customer']['cust_name']; ?></span></li>
						<li><a href="dashboard.php"><i class="fa fa-home"></i> <span><?php echo LANG_VALUE_89; ?></span></a></li>
						<?php
					} else {
						?>
						<li><a href="login.php"><i class="fa fa-sign-in"></i> <span><?php echo LANG_VALUE_9; ?></span></a></li>
						<li><a href="registration.php"><i class="fa fa-user-plus"></i> <span><?php echo LANG_VALUE_15; ?></span></a></li>
						<?php	
					}
					?>

					<li><a href="cart.php"><i class="fa fa-shopping-cart"></i> <span><?php echo LANG_VALUE_18; ?></span> <strong><?php echo LANG_VALUE_1; ?><?php
			...
			<div class="col-md-3 search-area">
				<form class="navbar-form navbar-left" role="search" action="search-result.php" method="get">
					...
					<!-- <div class="input-group-append">
						<button type="submit" class="btn btn-outline-secondary btn-danger" type="button"><?php echo LANG_VALUE_3; ?></button>
					</div> -->
